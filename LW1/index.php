...
<p align="center">
    <?php
    $Height = rand(1.0, 2.0); // Случайный рост в диапазоне от 1(м) до 2(м)
...
<p align="center">
    ...
    switch ($BMI) {
        ...
        case $BMI >= 35.0 and $BMI <= 39.9:
            ...
            break;
        case $BMI >= 40.0:
            echo "Классификация: Ожирение 3 степени.<br>Риск сопутствующих заболеваний: Черезвычайно высокий.";
            break;
    }
    unset($Height);
    unset($Weight);
...
<h4 align="center">Услуги в номер - двумерный ассоциативный массив</h4>
<table align="center" border="3">
    <?php
    $services = array(
        ...
        "Вана/душ в номере" => array("Душ", "Тропический душ", "Ванна", "Ванна с джакузи")
    );
...
<h4 align="center">Услуги в номер - многомерный ассоциативный массив</h4>
<table align="center" border="3">
    <?php
    $services = array(
        "Дешёвые номера" => array(
            "Эконом" => array(
                ...
                "Размер" => "20 кв/м",
                "Вид с окон" => "На двор",
                "Вана/душ в номере" => "Душ"
            ),
            "Стандарт" => array(
                "Цена" => "120$",
                "Размер" => "25 кв/м",
                "Вид с окон" => "На ресторанный дворик",
                "Вана/душ в номере" => "Тропический душ"
            )
        ),
        "Дорогие номера" => array(
            "Делюкс" => array(
                ...
                "Размер" => "55 кв/м",
                "Вид с окон" => "На море",
                "Вана/душ в номере" => "Ванна"
            ),
            "Люкс" => array(
                "Цена" => "400$",
                "Размер" => "84 кв/м",
                "Вид с окон" => "На море",
                "Вана/душ в номере" => "Ванна с джакузи"
            )
        )
    );
